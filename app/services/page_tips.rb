  ...
  def tips
    ...
    when "meetings#show"
      { "You can reorder submissions by dragging and dropping." => "info",
        ...
        "If attendees don't enter their own scores, then someone with the \"scores\" ability can do so for them (learn about abilities on by visiting the magazines page and clicking a staff list)." => "info",
